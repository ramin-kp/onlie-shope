  ...
  return (
    <>
      ...
      <main className="container">
        <div className="p-5 md:p-10 mx-2.5 my-10 bg-white dark:bg-dark-100 text-zinc-900 dark:text-white font-dana text-justify text-lg md:text-xl leading-10 rounded-2xl">
          <div>
            <h1 className="py-5 font-morabba text-xl xs:text-2xl md:text-4xl border-b border-gray-300 dark:border-gray-200">
              فروشگاه لوازم خانگی فرخی
            </h1>
            <h2 className="font-morabba text-lg xs:text-xl md:text-2xl pt-5">
              اولین و معتبرترین فروشگاه لوازم خانگی در بناب
            </h2>
          </div>

          <section className="py-5">
            <h2 className="font-morabba text-xl md:text-2xl py-3">درباره ما</h2>
            <p>
              با سلام و احترام، ما در <strong>فروشگاه لوازم خانگی فرخی</strong>{" "}
              با سابقه‌ای درخشان در زمینه فروش انواع لوازم خانگی، مفتخریم که به
              عنوان{" "}
            ...
            <p>
              با <strong>بهترین قیمت‌ها و شرایط پرداخت متنوع</strong>، پیدا
              کنید.
            </p>
          </section>

          <section className="py-5">
            <h2 className="font-morabba text-xl md:text-2xl py-3">خدمات ما</h2>
            <ul className="list-disc marker:text-primary-200">
              <li>مشاوره تخصصی</li>
              <li>گارانتی معتبر</li>
          ...
          <section className="py-5">
            <h2 className="font-morabba text-xl md:text-2xl py-3">
              آدرس و تماس
            </h2>
          ...
          <section className="py-5">
            <iframe
              ...
              className="w-full h-[250px] md:h-[450px] my-3"
            ></iframe>
          </section>
